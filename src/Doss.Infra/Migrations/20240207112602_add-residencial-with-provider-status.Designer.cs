...
namespace Doss.Infra.Migrations
{
    ...
    [Migration("20240207112602_add-residencial-with-provider-status")]
    partial class addresidencialwithproviderstatus
    {
            ...
            modelBuilder.Entity("Doss.Core.Domain.Residentials.ResidentialWithServiceProvider", b =>
                {
                    ...
                    b.Property<string>("ResidentialWithServiceProviderStatus")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
