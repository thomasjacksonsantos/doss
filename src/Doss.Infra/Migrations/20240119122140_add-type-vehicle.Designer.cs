...
namespace Doss.Infra.Migrations
{
    ...
    [Migration("20240119122140_add-type-vehicle")]
    partial class addtypevehicle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Doss.Core.Domain.Contacts.UsefulContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doss.Core.Domain.OnBoard.OnBoardVehicle", b =>
                {
                    ...
                    b.Property<Guid>("ModelVehicleId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doss.Core.Domain.Residentials.VerificationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doss.Core.Domain.Vehicles.BrandVehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BrandVehicle", "Doss");
                });

            modelBuilder.Entity("Doss.Core.Domain.Vehicles.ModelVehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doss.Core.Domain.Vehicles.ResidentialVehicle", b =>
                {
                    ...
                    b.ToTable("ResidentialVehicle", "Doss");
                });

            modelBuilder.Entity("Doss.Core.Domain.Vehicles.ServiceProviderVehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ServiceProviderVehicle", "Doss");
                });

            modelBuilder.Entity("Doss.Core.Domain.Vehicles.TypeVehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doss.Core.Domain.Vehicles.BrandVehicle", b =>
                {
                    b.HasOne("Doss.Core.Domain.Vehicles.TypeVehicle", "TypeVehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("Doss.Core.Domain.Vehicles.ModelVehicle", b =>
                {
                    b.HasOne("Doss.Core.Domain.Vehicles.BrandVehicle", "BrandVehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("Doss.Core.Domain.Vehicles.ServiceProviderVehicle", b =>
                {
                    b.HasOne("Doss.Core.Domain.ServiceProviders.ServiceProvider", null)
                        .WithMany("ServiceProviderVehicles")
                        .HasForeignKey("ServiceProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Doss.Core.Domain.Vehicles.Vehicle", b =>
                {
                    b.HasOne("Doss.Core.Domain.Vehicles.ModelVehicle", "ModelVehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("Doss.Core.Domain.ServiceProviders.ServiceProvider", b =>
                {
                    ...
                    b.Navigation("ServiceProviderVehicles");
                });
